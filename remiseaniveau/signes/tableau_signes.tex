...
\begin{tikzpicture}
\tkzTabInit[color,lgt=2,espcl=2,colorC=blue!20,colorV=blue!20]
{$x$/1,$x-\sqrt{\frac{7}{8}}$/1,$x+\sqrt{\frac{7}{8}}$/1 ,Signe\\de $A(x)$ / 1.5}
{$-\infty$, $-\sqrt{\frac{7}{8}}$,$\sqrt{\frac{7}{8}}$, $+\infty$}
\tkzTabLine{,-,t,-,z,+,}
\tkzTabLine{,-,z,+,t,+,}
\tkzTabLine{,+,z,-,z,+,}
\end{tikzpicture}
...
\begin{tikzpicture}
\tkzTabInit[color,lgt=2,espcl=2,colorC=blue!20,colorV=blue!20]
{$x$/1,Signe\\de $D(x)$ / 1.5}
{$-\infty$, $-\sqrt{X_1}$,$\sqrt{X_1}$, $+\infty$}
\tkzTabLine{,+,z,-,z,+,}
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}
\tkzTabInit[color,lgt=2,espcl=2,colorC=blue!20,colorV=blue!20]
{$x$/1,Signe\\de $E(x)$ / 1.5}
{$-\infty$, $\frac{1}{4}$,$\frac{2}{5}$, $+\infty$}
\tkzTabLine{,+,z,-,z,+,}
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}
\tkzTabInit[color,lgt=2,espcl=2,colorC=blue!20,colorV=blue!20]
{$x$/1,$8x-2$/1, $10x-4$/1, Signe\\de $E(x)$ / 1.5}
{$-\infty$, $\frac{1}{4}$,$\frac{2}{5}$, $+\infty$}
\tkzTabLine{,-,z,+,t,+,}
\tkzTabLine{,-,t,-,z,+,}
\tkzTabLine{,+,z,-,z,+,}
...
\begin{tikzpicture}
\tkzTabInit[color,lgt=2,espcl=2,colorC=blue!20,colorV=blue!20]
{$x$/1,$\e^x-1$/1, $\e^x-\e^2$/1, Signe\\de $A(x)$ / 1.5}
{$-\infty$, $0$,$2$, $+\infty$}
\tkzTabLine{,-,z,+,t,+,}
\tkzTabLine{,-,t,-,z,+,}
\tkzTabLine{,+,z,-,d,+,}
